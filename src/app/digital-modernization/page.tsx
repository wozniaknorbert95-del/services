...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: '/og/modernization.svg',
        width: 1200,
        height: 630,
        alt: 'Digital Modernization — Coming Soon',
      },
    ],
  },
  twitter: {
  ...
  return (
    <main className="flex min-h-[calc(100vh-64px)] flex-col items-center justify-center px-6 py-24 text-center">
      <div className="mx-auto max-w-2xl">
        <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-[var(--qf-accent)] px-3 py-1 text-xs font-mono font-medium text-[var(--qf-accent)]">
          <Bell className="h-3 w-3" />
          Coming in 14 days
        </div>

        <h1 className="text-3xl font-bold tracking-tight text-[var(--qf-text)] sm:text-4xl">
          Digital Modernization
        </h1>
        <p className="mx-auto mt-4 max-w-lg text-lg text-[var(--qf-text-dim)]">
        ...
        <Card className="mx-auto mt-10 max-w-md text-left">
          <h2 className="font-semibold text-[var(--qf-text)]">Join the waitlist</h2>
          <p className="mt-1 text-sm text-[var(--qf-text-dim)]">
        ...
        <div className="mt-8">
          <a
            href="/"
            className="inline-flex items-center gap-2 text-sm text-[var(--qf-accent)] transition-colors hover:text-[var(--qf-accent-soft)]"
          >
            &larr; Back to home
          </a>
        </div>
