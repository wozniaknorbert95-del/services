...
Session artifacts, legacy wireframes, and completed plans. **Do not load by default** — see [`docs/README.md`](../README.md).
...
One-off scripts: [`scripts/archive/`](../../scripts/archive/README.md)
